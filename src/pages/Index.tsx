      ...
      <header className="sticky top-0 z-20 border-b border-white/20 bg-white/30 backdrop-blur-2xl">
        <div className="mx-auto flex max-w-2xl items-center justify-between px-5 py-4">
          <div className="flex items-center gap-3">
            ...
            <span className="font-serif text-xl font-semibold tracking-normal text-violet-deep whitespace-nowrap">Живые <span className="accent-italic font-normal">Смыслы</span></span>
          </div>
